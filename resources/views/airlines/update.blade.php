...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      <h1> Updating Airline </h1>
      {!! Form::open(['route'=> ['airlines.update', $airline->id], 'method' => 'put']) !!}
      <div class="form-controller">
        {!! Form::label('label', 'update the airline name') !!}:
        ...
        <br />
        {!! Form::label('departing', 'update the departing') !!}:
        {!! Form::text('departing', null, ['class'=>'departing']) !!}

        <br />
        {!! Form::label('landing', 'update the landing') !!}:
